function [ktbasis,ktbasis_orig,ktbasprs] = makeKbasis(dtStim, dtSp, klength, nkbasis)
...
ktbasprs.b = 5; % Offset for nonlinear scaling (larger -> more linear), Originally it's 5
