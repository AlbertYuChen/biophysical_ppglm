% Author: Yu Chen
% Date: November-13-2022 @ Hollingsworth NYC

function Tau = KS_Haslinger_on_trials_paper(stim, spike_train, KS_test_trials, gg0, KS_valid_point_range, title_name)
...
figure('Position', [200, 200, 320, 300])
